...
import { Politicas, ButtonLog} from "../components/elements";
    ...
    <div>
      <Politicas>
        <p> 
          ...
          <br />
          <hr></hr>
          El presente Política de Privacidad establece los términos en que usa y
          protege la información que es proporcionada por sus usuarios al
          momento de utilizar esta aplicación. <br />
          ...
          <br /> Nuestro sitio web podrá recoger información personal por
          ...
          proporcione y podrán ser cancelados en cualquier momento. Está
          ...
          <hr></hr>
          Cookies:
          <br /> Una cookie se refiere a un fichero que es enviado con la
          ...
          permanente. Usted puede eliminar las cookies en cualquier momento
          desde su ordenador. Sin embargo las cookies ayudan a proporcionar un
          mejor servicio de los sitios web, estás no dan acceso a información de
          su ordenador ni de usted, a menos de que usted así lo quiera y la
          proporcione directamente noticias. Usted puede aceptar o negar el uso
          ...
          nuestros servicios.
          <br />
          <hr></hr>Enlaces a Terceros:
          <br /> Este sitio web pudiera contener en laces a otros sitios que
          ...
          <br /> Control de su información personal En cualquier momento usted
          puede restringir la recopilación o el uso de la información personal
          que es proporcionada a nuestro sitio web. Cada vez que se le solicite
          ...
          <br />
          <hr></hr> Se reserva el derecho de cambiar los términos de la presente
          Política de Privacidad en cualquier momento.
        </p>
      </Politicas>
        <Link className='linkComp' to='/'>
                    <ButtonLog>Volver</ButtonLog>
        </Link>
